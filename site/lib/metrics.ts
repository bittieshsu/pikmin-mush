...
export const SUPPORTED_GAME_VERSIONS = ["149.0", "150.0", "151.0", "152.0", "153.0"] as const;
export const REQUIRED_GAME_VERSION = "153.0";
export const MIN_AGENT_VERSION = "2.0.0";
export const EXPECTED_MODULE_VERSION = "153.0";
