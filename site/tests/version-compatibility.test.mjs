...
test("153 rollout preserves older matching versions and rejects mismatches", () => {
  for (const version of ["149.0", "150.0", "151.0", "152.0", "153.0"]) {
  ...
  for (const [game, module, agent] of [
    ...
    ["153.0", "152.0", "2.2.0"], ["152.0", "153.0", "2.2.0"],
    ["154.0", "154.0", "2.2.0"], ["152.0", "152.0", "1.9.9"],
  ]) {
